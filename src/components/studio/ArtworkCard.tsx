          ...
          <div className="absolute top-3 right-3 flex gap-1.5 opacity-0 transition-opacity duration-300 group-hover:opacity-100 focus-within:opacity-100">
            {onEdit && (
              <button
                ...
                className="rounded-full border border-border-strong bg-background/70 p-2 text-muted-foreground backdrop-blur-md transition-colors hover:text-foreground"
              >
            ...
            {onDelete && (
              <button
                ...
                className="rounded-full border border-border-strong bg-background/70 p-2 text-muted-foreground backdrop-blur-md transition-colors hover:text-destructive"
              >
